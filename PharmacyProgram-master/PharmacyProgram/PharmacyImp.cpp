...
{
	cout << "PharmaTech Version 1.1.0" << endl;

	//write some more shit that explains to a pharmacist how to fill a prescription.
	cout << "\nWelcome to Pharmatech, this program assists pharmacists with filling patients'\n"
		<< "perscriptions of various medications, keeps up-to-date counts of current stock\n"
		<< "of medications, updates stock when medications are replenished or there is a\n"
		<< "numerical error, and displays a list of recipts.\nFor security reasons, only"
		<< "pharmacists who have a registered username, ID number,\nand password may log"
		<< "into Pharmatech.\n";
}
...
void Pharmacy::fillPrescription()
{
	...
	do
	{
		...
		cout << "Please enter the name of the medication in all capitals that you would like to fill the prescription of.\n"
			<< "(Medication names range from [MEDICATION1] to [MEDICATION200])\n";
		cin >> whichMedication;
